...
function App() {
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <p className="text-gray-500 text-center font-bold mb-5">Realizado por <span className="text-indigo-500 italic">Luis Dominguez</span></p>
      ...
      <div className="bg-indigo-600 hover:bg-indigo-800 w-5/12 mx-auto rounded">
        <a class="text-white flex justify-center items-center" href="https://github.com/luisedr98">
          <div>
            <img src="./src/assets/github.svg" alt="imagen"/>
          </div>
          <p>github</p>
        </a>
      </div>   
